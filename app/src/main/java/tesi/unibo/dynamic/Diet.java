...
public interface Diet {
	 ...
	 * @param nutritionMap gives a map from a nutrient to how many calories it brings 
	 * with 100 grams of food
	 ...
	 * Note that if 100 grams of 'pasta' give 50 calories of FAT (according 
	 * to nutritionMap above),
